...
@section('admin')
 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">সকল স্টক রিপোর্ট</h4>
    ...
    <a href="{{ route('stock.report.pdf') }}" target="_blank" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"> স্টক রিপোর্ট প্রিন্ট </i></a> <br>  <br>

                    <h4 class="card-title">স্টক রিপোর্ট </h4>
