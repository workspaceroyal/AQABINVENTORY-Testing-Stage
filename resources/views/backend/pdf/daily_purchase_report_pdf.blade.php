 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">দৈনিক ক্রয় রিপোর্ট</h4>

                                    <div class="page-title-right">
                                        <ol class="m-0 breadcrumb">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">দৈনিক ক্রয় রিপোর্ট</li>
                                        </ol>
                                    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div>
                <div class="p-2">
                    <h3 class="font-size-16"><strong>দৈনিক ক্রয় রিপোর্ট
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>ক্রয় নং</strong></td>
            ...
            <td class="text-center"><strong>প্রতিটির মূলত</strong>
            </td>
