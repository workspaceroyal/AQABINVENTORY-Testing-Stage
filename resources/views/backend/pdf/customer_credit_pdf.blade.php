                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">ক্রেতার বাকি রিপোর্ট</h4>

                                    <div class="page-title-right">
                                        <ol class="m-0 breadcrumb">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"> </a></li>
                                            <li class="breadcrumb-item active">ক্রেতার বাকি রিপোর্ট</li>
                                        </ol>
                                    </div>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>ইনভয়েভ নং</strong>
            </td>
            <td class="text-center"><strong>তারিখ</strong>
            </td>

            <td class="text-center"><strong>বাকির পরিমাণ</strong>
            </td>
